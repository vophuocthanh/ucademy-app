...
import { updateCourse } from '@/lib/actions/cource.actions';
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <div className='h-[200px] bg-white rounded-md border dark:bg-grayDarker dark:border-grayDark border-gray-200'></div>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
